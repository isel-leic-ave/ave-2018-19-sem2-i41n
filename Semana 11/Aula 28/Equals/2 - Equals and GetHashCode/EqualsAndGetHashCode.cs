...
namespace EqualsAndGetHashCode
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("After p1.SetX(10);");
            ////////////////////////////////////////////
            Console.WriteLine("pointHashSet.Contains(p1) = {0}", pointHashSet.Contains(p1));
            ...
            p1.SetY(1);
            Console.WriteLine("After p1.SetX(2); p1.SetY(1);");
            foreach (var b in pointHashSet)
            {
                Console.WriteLine("b = {0}", b);
            }
            ...
            Console.WriteLine("pointHashSet.Contains(p2) = {0}", pointHashSet.Contains(p2));
            Console.WriteLine("pointHashSet.Remove(p2) -> {0}", pointHashSet.Remove(p2));
            Console.WriteLine("p1 = {0}", p1);
            Console.WriteLine("p2 = {0}", p2);
            Console.WriteLine("p1.GetHashCode() = {0}", p1.GetHashCode());
            Console.WriteLine("p2.GetHashCode() = {0}", p2.GetHashCode());
            ...
            //After p1.SetX(2); p1.SetY(1);
            //pointHashSet.Remove(p1)->False
            //pointHashSet.Remove(p2)->True
            //p1 = (2, 1)
            //p2 = (2, 1)
            ...
            //p1 = (2, 1)
            //p2 = (2, 1)
            //p1.GetHashCode() = 3     OK, Equals true => same hash. Hence, the object is the same and shouldn't be duplicated in the hash table
            //p2.GetHashCode() = 3
            //p1.Equals(p2) ? True
            ...
            //pointHashSet.Remove(p1)->False    // Problem, object could not be found in hash collection
            //After p1.SetX(2); p1.SetY(1);
            //pointHashSet.Remove(p1)->True     // Problem, it removed p2 instead of p1
            //pointHashSet.Remove(p2)->False    // Problem, object p2 was already removed
            //p1 = (2, 1)
            //p2 = (2, 1)
            //p1.GetHashCode() = 57    OK, Equals true => same hash. Hence, the object is the same and shouldn't be duplicated in the hash table
            //p2.GetHashCode() = 57
            //p1.Equals(p2) ? True
