...
namespace Equals
{
    class Point2D
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            //if (obj is Point2D) // Caso 1 - Teste de compatibilidade - Errado, Não funciona sempre -> Ver Exemplo 2 abaixo
        ...
        {            
            ...
            return false;  // Erroneously returns false, just for testing purposes
        }
        public static bool operator !=(Point2D p, Object o)
        {
            return !(p == o);
